...
const ButtonClose = ({ color, onClick }:any) => {
...
export default () => {
    ...
    const numOfErrors = errors? Object.keys(errors).length: 0;
    ...
    return (
        <div className="fixed bottom-10 right-10 max-w-3xl z-20">
            {flash.success.length>0  && visible && (
            ...
            {(flash.error.length>0 || numOfErrors > 0) && visible && (
